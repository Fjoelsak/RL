    ...
    def sarsa(self, env, alpha=0.1, epsilon=0.1, eps_decay=0.99, n_episodes=1000):
        ...
        for e in range(n_episodes):
            ...
            while True:
                ...
                next_action = self.epsilon_greedy(env, Q, next_state, epsilon)

                Q[state, action] += alpha * (reward + self.gamma * Q[next_state, next_action] - Q[state, action])
            ...
            rewards_per_episode.append(reward_eps)
    ...
    def qlearning(self, env, alpha=0.1, epsilon=0.1, eps_decay=0.99, n_episodes=1000):
        ...
        for e in range(n_episodes):
            ...
            while True:
                ...
                Q[state, action] += alpha * (reward + self.gamma * np.max(Q[next_state, :]) - Q[state, action])
            ...
            rewards_per_epsisode.append(reward_eps)
